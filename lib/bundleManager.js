...
var isLocal = fs.existsSync(process.cwd() + '/spas.js');

var bundlesFolder = isLocal ? process.cwd() + '/bundles' : process.cwd();
if (isLocal && !fs.existsSync(bundlesFolder)) fs.mkdirSync(bundlesFolder);
